...
{
    public class AllocatedPatBillableItemsAccountResultModel
    {
        ...
        public ObservableCollection<AllocatedPatBillableItemsSubAccountResultModel> AllocatedPatBillableItemsSubGroups { get; set; }
