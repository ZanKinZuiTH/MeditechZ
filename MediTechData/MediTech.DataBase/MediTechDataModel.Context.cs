...
namespace MediTech.DataBase
{
    ...
    public partial class MediTechEntities : DbContext
    {
        ...
        public virtual ObjectResult<pGetAdjustablePackageItems_Result> pGetAdjustablePackageItems(Nullable<long> p_PatientUID, Nullable<long> p_PatientVisitUID, Nullable<int> p_BillPackageUID)
        {
            var p_PatientUIDParameter = p_PatientUID.HasValue ?
                new ObjectParameter("P_PatientUID", p_PatientUID) :
                new ObjectParameter("P_PatientUID", typeof(long));
            ...
            var p_BillPackageUIDParameter = p_BillPackageUID.HasValue ?
                new ObjectParameter("P_BillPackageUID", p_BillPackageUID) :
                new ObjectParameter("P_BillPackageUID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<pGetAdjustablePackageItems_Result>("pGetAdjustablePackageItems", p_PatientUIDParameter, p_PatientVisitUIDParameter, p_BillPackageUIDParameter);
        }
    
        public virtual ObjectResult<pSearchBillPackageItem_Result> pSearchBillPackageItem(string p_Text, Nullable<int> p_OrderCategoryUID, Nullable<int> p_OrderSubCategoryUID)
        {
            var p_TextParameter = p_Text != null ?
                new ObjectParameter("P_Text", p_Text) :
                new ObjectParameter("P_Text", typeof(string));
    
            var p_OrderCategoryUIDParameter = p_OrderCategoryUID.HasValue ?
                new ObjectParameter("P_OrderCategoryUID", p_OrderCategoryUID) :
                new ObjectParameter("P_OrderCategoryUID", typeof(int));
    
            var p_OrderSubCategoryUIDParameter = p_OrderSubCategoryUID.HasValue ?
                new ObjectParameter("P_OrderSubCategoryUID", p_OrderSubCategoryUID) :
                new ObjectParameter("P_OrderSubCategoryUID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<pSearchBillPackageItem_Result>("pSearchBillPackageItem", p_TextParameter, p_OrderCategoryUIDParameter, p_OrderSubCategoryUIDParameter);
        }
    
        public virtual ObjectResult<pRPTUCSAndForeignerFee_Result> pRPTUCSAndForeignerFee(Nullable<System.DateTime> p_DateFrom, Nullable<System.DateTime> p_DateTo)
        {
            var p_DateFromParameter = p_DateFrom.HasValue ?
                new ObjectParameter("P_DateFrom", p_DateFrom) :
                new ObjectParameter("P_DateFrom", typeof(System.DateTime));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<pRPTUCSAndForeignerFee_Result>("pRPTUCSAndForeignerFee", p_DateFromParameter, p_DateToParameter);
        }
    }
}
