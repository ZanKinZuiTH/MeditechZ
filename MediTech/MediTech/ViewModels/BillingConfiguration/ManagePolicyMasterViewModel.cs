...
namespace MediTech.ViewModels
{
    public class ManagePolicyMasterViewModel : MediTechViewModelBase
    {
        ...
        private void Save()
        {
            ...
            DataService.MasterData.ManagePolicyMaster(policyMasterModel, AppUtil.Current.UserID);
        ...
        {
            policyMasterModel = DataService.MasterData.GetPolicyMasterByUID(policyMasterUID);
