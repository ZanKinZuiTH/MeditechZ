...
namespace MediTech.ViewModels
{
    public class ListPolicyMasterViewModel : MediTechViewModelBase
    {
        ...
        {
            PolicyMasterSource = DataService.MasterData.GetPolicyMasterAll();
        }

        private void Search()
        {
            PolicyMasterSource = DataService.MasterData.SearchPolicyMaster(ItemCode, ItemName);
        }
        ...
        private void Delete()
        {
            if (SelectPolicyMaster != null)
            {
                try
                {
                    ...
                    {
                        DataService.MasterData.DeletePolicyMaster(SelectPolicyMaster.PolicyMasterUID, AppUtil.Current.UserID);
                        DeleteSuccessDialog();
