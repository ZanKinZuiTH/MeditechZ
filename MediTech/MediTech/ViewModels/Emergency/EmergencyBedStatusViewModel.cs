...
namespace MediTech.ViewModels
{
    public class EmergencyBedStatusViewModel : MediTechViewModelBase
    {
        ...
        private LocationModel _SelectBedData;

        public LocationModel SelectBedData
        {
        ...
        private void PatientRecords()
        {
            if (SelectBedData != null)
            {
                ...
                visitModel.PatientVisitUID = SelectBedData.PatientVisitUID;
        ...
        private void ManageAEAdmission()
        {
            ...
            if (SelectBedData != null)
            {
                PatientAEAdmissionModel erVisit = DataService.PatientIdentity.GetPatientAEAdmissionByUID(SelectBedData.PatientVisitUID);
