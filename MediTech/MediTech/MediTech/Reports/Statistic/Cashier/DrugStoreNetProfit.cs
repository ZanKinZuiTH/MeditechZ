...
{
    public partial class DrugStoreNetProfit : DevExpress.XtraReports.UI.XtraReport
    {
        public DrugStoreNetProfit()
        {
            InitializeComponent();
        ...
        void DrugStoreNetProfit_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            xrPivotGrid1.DataSource = (new ReportsService()).GetDrugStoreNetProfit(dateFrom, dateTo, organisationUID);
        }
