...
{
	public partial class UltrasoundFeeReport : DevExpress.XtraReports.UI.XtraReport
	{	
		public UltrasoundFeeReport()
		{
			InitializeComponent();
        ...
        private void DoctorFeeReport_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            var data = (new ReportsService()).GetUltrasoundFee(dateFrom, dateTo, careproviderUID);
