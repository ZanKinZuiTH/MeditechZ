    ...
    public class RunPatientReportsViewModel : MediTechViewModelBase
    {
        ...
        private void PreviewReport()
        {
            ...
            { 
                ...
                else if (SelectReport.Name == "ใบรับรองแพทย์กายภาพ" || SelectReport.Name == "ใบรับรองแพทย์ที่อับอากาศ (Mobile)" || SelectReport.Name == "ใบรับรองแพทย์ 5 โรค (Mobile)" || SelectReport.Name == "ใบรับรองแพทย์ต่างชาติ")
                {
                    report.Parameters["OrganisationUID"].Value = SelectPatientVisit.OwnerOrganisationUID;
