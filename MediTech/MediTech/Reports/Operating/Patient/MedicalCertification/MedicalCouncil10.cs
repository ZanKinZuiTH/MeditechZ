...
{
    public partial class MedicalCouncil10 : DevExpress.XtraReports.UI.XtraReport
    {
        List<HealthOrganisationModel> Organisations = new List<HealthOrganisationModel>();
        public MedicalCouncil10()
        {
            InitializeComponent();
            ...
            this.BeforePrint += MedicalCouncil10_BeforePrint;
        }

        private void MedicalCouncil10_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            if (logoType == 0)
            {
                ...
                lbOrganisationPlace.Text = OrganisationDefault.Description.ToString() != null ? "สถานพยาบาล (๑) " + OrganisationDefault.Description.ToString() : "";
