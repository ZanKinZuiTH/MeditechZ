...
{
    public partial class VisitTimesStatistic : DevExpress.XtraReports.UI.XtraReport
    {
        public VisitTimesStatistic()
        {
            InitializeComponent();
            this.BeforePrint += VisitTimesStatistic_BeforePrint;
        }

        private void VisitTimesStatistic_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            List<ChartStatisticModel> dataStatistic = (new ReportsService()).VisitTimesStatistic(dateFrom, dateTo, vistyuid != 0 ? vistyuid : (int?)null, organisationUID != 0 ? organisationUID : (int?)null);

            this.xrChart1.BeginInit();
            Series series = new Series("Time", ViewType.Line);
            ...
            chartTitle1.Text = "แผนภูมิเส้นแสดงสถิติช่วงเวลาที่มีผู้เข้ารับบริการ";
            ...
            if (dataStatistic != null)
            {
                ...
                xrTable1.LocationFloat = new DevExpress.Utils.PointFloat(22.5f, 54.25f);
