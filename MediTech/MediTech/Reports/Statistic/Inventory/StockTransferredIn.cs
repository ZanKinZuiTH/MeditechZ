...
{
    public partial class StockTransferredIn : DevExpress.XtraReports.UI.XtraReport
    {
        public StockTransferredIn()
        {
            InitializeComponent();
        ...
        void DrugStoreNetProfit_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            var dataReport = (new ReportsService()).StockTransferredInReport(dateFrom, dateTo, organisationList);
