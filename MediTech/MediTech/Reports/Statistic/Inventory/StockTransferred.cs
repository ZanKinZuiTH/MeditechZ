...
{
    public partial class StockTransferred : DevExpress.XtraReports.UI.XtraReport
    {
        public StockTransferred()
        {
            InitializeComponent();
        ...
        void DrugStoreNetProfit_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            var dataReport = (new ReportsService()).StockTransferredReport(dateFrom, dateTo, organisationUID);
