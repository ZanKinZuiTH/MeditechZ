...
- **ผู้ช่วย AI สำหรับเอกสารทางการแพทย์** - ช่วยในการกรอกข้อมูลใบรับรองแพทย์และสมุดตรวจสุขภาพอัตโนมัติ
- **การวิเคราะห์ความมั่นใจในการวินิจฉัย** - แสดงระดับความมั่นใจและการวินิจฉัยแยกโรคที่เป็นไปได้
- **คำแนะนำการรักษาอัตโนมัติ** - ให้คำแนะนำเบื้องต้นตามผลการวินิจฉัย

### 7. ระบบนำเข้าเอกสารด้วย AI (AI Document Import)
- **การนำเข้าเอกสาร Excel จากภาพ** - แปลงภาพถ่ายตารางข้อมูลเป็นไฟล์ Excel ที่ใช้งานได้
- **การสกัดข้อมูลจากเอกสารทางการแพทย์** - ใช้ AI วิเคราะห์และสกัดข้อมูลจากเอกสารทางการแพทย์
- **การตรวจจับและแยกตาราง** - ระบุตำแหน่งตารางในภาพและแยกข้อมูลออกมาเป็นโครงสร้าง
- **การตรวจสอบและแก้ไขข้อมูล** - ตรวจสอบความถูกต้องและแก้ไขข้อมูลที่สกัดได้ก่อนบันทึก
- **การนำเข้าข้อมูลอัตโนมัติ** - บันทึกข้อมูลที่สกัดได้เข้าสู่ระบบโดยอัตโนมัติ
- **การรองรับเทมเพลตหลากหลายรูปแบบ** - รองรับเอกสารหลายรูปแบบและสามารถเพิ่มเทมเพลตใหม่ได้
...
- **OpenCV** - Library สำหรับการประมวลผลภาพและคอมพิวเตอร์วิชัน
- **Tesseract OCR** - เครื่องมือ OCR สำหรับการสกัดข้อมูลจากภาพ
- **Pandas** - Library สำหรับการจัดการและวิเคราะห์ข้อมูลตาราง
- **Table Transformer** - โมเดล AI สำหรับการตรวจจับและสกัดข้อมูลจากตาราง
...
### เวอร์ชัน 0.6.0 (มีนาคม 2025)
- **เพิ่มระบบนำเข้าเอกสาร Excel จากภาพและใช้ AI ในการแยกข้อมูล**
  - คอมโพเนนต์ `DocumentImportAI` สำหรับอัพโหลดและประมวลผลภาพเอกสาร
  - ระบบตรวจจับและแยกข้อมูลจากตารางในภาพด้วย AI
  - รองรับการนำเข้าข้อมูลจากผลตรวจทางห้องปฏิบัติการและเอกสารทางการแพทย์
  - ฮุค `useDocumentImportAI` สำหรับจัดการการนำเข้าเอกสาร
  - หน้า `DocumentImportPage` สำหรับการนำเข้าเอกสารด้วย AI
  - API Endpoint `/api/v1/document-import/process` สำหรับประมวลผลภาพเอกสาร
  - ระบบตรวจสอบและแก้ไขข้อมูลที่สกัดได้ก่อนบันทึกเข้าสู่ระบบ
- **ปรับปรุงประสิทธิภาพการประมวลผลภาพและความแม่นยำในการสกัดข้อมูล**
- **เพิ่มการรองรับเทมเพลตเอกสารหลากหลายรูปแบบ**

### เวอร์ชัน 0.5.0 (มีนาคม 2025)
- **เพิ่มระบบ AI สำหรับช่วยในการจัดการใบรับรองแพทย์และสมุดตรวจสุขภาพ**
  - คอมโพเนนต์ `DiagnosisResult` สำหรับแสดงผลการวินิจฉัยจาก AI
  - คอมโพเนนต์ `SymptomSelector` สำหรับเลือกอาการเพื่อวิเคราะห์
  - ผู้ช่วย AI สำหรับการกรอกข้อมูลสมุดตรวจสุขภาพและใบรับรองแพทย์
  - ฮุค `useAiDiagnosis` สำหรับเรียกใช้ API การวินิจฉัยด้วย AI
  - หน้า AI Assistant สำหรับการจัดการเอกสารทางการแพทย์
- **ปรับปรุงประสิทธิภาพและความเสถียรของระบบ**
- **แก้ไขข้อบกพร่องที่พบในเวอร์ชันก่อนหน้า**

### เวอร์ชัน 0.4.0 (กุมภาพันธ์ 2025)
- เพิ่มระบบการจัดการเอกสารทางการแพทย์
- ปรับปรุงส่วนติดต่อผู้ใช้ให้ใช้งานง่ายขึ้น
- เพิ่มการรองรับภาษาไทยในส่วนต่างๆ ของระบบ
