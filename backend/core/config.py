...
class Settings(BaseSettings):
    ...
    PROJECT_NAME: str = "MediTech API"
    PROJECT_DESCRIPTION: str = "ระบบสารสนเทศทางการแพทย์"
    PROJECT_VERSION: str = "0.1.0"
    
    POSTGRES_SERVER: str = "localhost"
    POSTGRES_USER: str = "postgres"
    POSTGRES_PASSWORD: str = "postgres"
    POSTGRES_DB: str = "meditech"
    ...
    FIRST_SUPERUSER: EmailStr = "admin@meditech.com"
