...
namespace MediTechWebApi.Controllers
{
    ...
    public class MasterDataController : ApiController
    {
        ...
        public HttpResponseMessage ManagePayorDetail(PayorDetailModel payorDetailModel, int userID)
        {
            try
            {
                ...
                using (var tran = new TransactionScope())
                {
                    ...
                    if (payorDetailModel.PayorAgrrements != null)
                    {
                        foreach (var item in payorDetailModel.PayorAgrrements)
                        {
                            PayorAgreement payorAgreement = db.PayorAgreement.Find(item.PayorAgreementUID);
        ...
        [Route("GetAgreementByPayorDetailUID")]
        [HttpGet]
